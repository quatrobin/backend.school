    ...
    public partial class AddBooks : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCourses", x => new { x.BooksId, x.CoursesId });
                    table.ForeignKey(
                        name: "FK_BookCourses_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCourses_Courses_CoursesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentSubmissions_CourseEnrollments_CourseEnrollmentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Роль для учеников", "Ученик" },
                    { 2, "Роль для преподавателей", "Преподаватель" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentSubmissions_CourseEnrollmentId",
                table: "AssignmentSubmissions",
